...
grep -q "npm ci" "$tmp_dir/demo/frontend/Dockerfile"
grep -q "@vitejs/plugin-react" "$tmp_dir/demo/frontend/package.json"
grep -q '"react": "19.2.7"' "$tmp_dir/demo/frontend/package.json"
grep -q "target: 'http://backend:8080'" "$tmp_dir/demo/frontend/vite.config.js"
grep -q '/api/${mode}' "$tmp_dir/demo/frontend/src/main.jsx"
grep -q "React frontend + C API + Postgres" "$tmp_dir/demo/frontend/src/main.jsx"
